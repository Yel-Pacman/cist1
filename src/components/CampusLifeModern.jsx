...
const CampusLifeModern = () => {
  ...
  const galleryItems = [
    { id: 1, src: '/src/assets/images/hero1.png', category: 'academics', title: 'Modern Classrooms' },
    { id: 2, src: '/src/assets/images/hero2.png', category: 'sports', title: 'Sports Facilities' },
    { id: 3, src: '/src/assets/images/hero3.png', category: 'arts', title: 'Art Studio' },
    { id: 4, src: '/src/assets/images/hero1.png', category: 'community', title: 'Student Events' },
    { id: 5, src: '/src/assets/images/hero2.png', category: 'academics', title: 'Science Lab' },
    { id: 6, src: '/src/assets/images/hero3.png', category: 'sports', title: 'Swimming Pool' },
  ];
